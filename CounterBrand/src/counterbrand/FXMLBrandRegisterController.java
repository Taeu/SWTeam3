...
public class FXMLBrandRegisterController implements Initializable {
    ...
    private void btnSignInSubmitCliked(ActionEvent event) {
        ...
        */
        ...
        try {
            brandSubmitList = brandManger.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userBrand.xml");
            idhm = brandManger.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userBrand.xml");
            // ok no problem.
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (brandSubmitList == null || brandSubmitList.get(Integer.toString(a)) == null) { // 이 부분이 좀 이상한가?
            try {
                ...
                brandManger.editXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userBrand.xml", hm);
