...
public class FXMLComplainDetailFeedbackReadController implements Initializable {
    ...
    public void initComplainDetailReadView() {
        ...
        hm = new HashMap();
        try {
            hm = complainManager.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complainDetail.xml");
        ...
        while (iterator.hasNext()) {
            ...
            try {
                complainManager.deleteIdXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complainDetail.xml", key);
    ...
    private void btnFeedbackSubmitClicked(ActionEvent event) {  //수정
        ...
        data = FXCollections.observableArrayList();
        try {
            complainManager.addFeedbackXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complainDetail.xml", cdkey, c, fbdate);
        ...
        if (complainSubmitList == null || complainSubmitList.get(Integer.toString(a)) == null) { // 이 부분이 좀 이상한가?
            try {
                ...
                complainManager.editXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complain.xml", hm);
                complainManager.editXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complainDetail.xml", hm);
