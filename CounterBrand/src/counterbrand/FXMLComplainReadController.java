...
public class FXMLComplainReadController implements Initializable {
    ...
    private void initComplainReadTableView() {
        ...
        try {
            hm = complainManager.readXML("C:\\Users\\user\\Documents\\NetBeansProjects\\CounterBrand\\src\\counterbrand\\", "complain.xml");
    ...
    private void ComplainReadDetailCliked(MouseEvent event) throws IOException {
        ...
        try {
            complainDetailList = complainManager.readXML("C:\\Users\\user\\Documents\\NetBeansProjects\\CounterBrand\\src\\counterbrand\\", "complainDetail.xml");
