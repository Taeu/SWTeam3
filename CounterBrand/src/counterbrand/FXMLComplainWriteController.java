...
public class FXMLComplainWriteController implements Initializable {
    ...
    private void btnComplainSubmitCliked(ActionEvent event) throws IOException, Exception {
        ...
        try {
            complainSubmitList = complainManager.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complain.xml");
            idhm = complainManager.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "complain.xml");
            // ok no problem.
        } catch (Exception e) {
            e.printStackTrace();
        }
