...
public class FXMLCustomerRegisterController implements Initializable {
    ...
    private void btnCustomerRegisterClicked(ActionEvent event) {
        ...
        */
        ...
        try {
            customerSubmitList = customerManger.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userCustomer.xml");
            idhm = customerManger.readXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userCustomer.xml");
            // ok no problem.
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (customerSubmitList == null || customerSubmitList.get(Integer.toString(a)) == null) { // 이 부분이 좀 이상한가?
            try {
                ...
                customerManger.editXML("C:\\Users\\JAEHOON\\Documents\\GitHub\\SWTeam3\\CounterBrand\\src\\counterbrand\\", "userCustomer.xml", hm);
